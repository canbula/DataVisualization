...
car_list = []
while True:
    cars = browser.find_elements(by=By.CSS_SELECTOR, value='.searchResultsItem:not(.nativeAd):not(.classicNativeAd)')   # ADS REMOVED
    for c in cars:
        ...
        try:
            ...
            continue
    try:
        button = browser.find_element(By.CSS_SELECTOR, value=".prevNextBut[title='Sonraki']")
